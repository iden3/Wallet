 ...
 */
export function createIdentity(passphrase, relayAddr = APP_SETTINGS.RELAY_ADDR) {
 ...
 */
export function createIdentityInStorage(idAddress, data, storage = APP_SETTINGS.LOCAL_STORAGE) {
 ...
 */
export function updateIdentitiesNumber(isToAdd, storage = APP_SETTINGS.LOCAL_STORAGE) {
  if (storage === APP_SETTINGS.LOCAL_STORAGE) {
 ...
 */
export async function updateIdentity(identity, data, passphrase, storage = APP_SETTINGS.LOCAL_STORAGE) {
