...
import identities from 'state/identities/reducer';
 ...
 *
 */
export const isIdentityConsistent = function (identity) {
 ...
 */
export const createIdentity = function (idAddr, data, storage = APP_SETTINGS.LOCAL_STORAGE) {
 ...
 */
export const areIdentitiesConsistent = function (storage = APP_SETTINGS.LOCAL_STORAGE) {
  let rightIds = 0;
  const _storage = getStorage(storage);
  ...
  for (let i = 0; i < storageKeysLength; i++) {
    ...
    const isIdConsistent = isIdentityConsistent(currentItem, storage);
 ...
 */
export const getAllIdentities = function (storage = APP_SETTINGS.LOCAL_STORAGE) {
  const _storage = getStorage(storage);
 ...
 */
export const getIdentity = function (iddAddr, storage = APP_SETTINGS.LOCAL_STORAGE) {
  const _storage = getStorage(storage);
  let identity;
 ...
 */
export const removeIdentity = function (identityKey, storage = APP_SETTINGS.LOCAL_STORAGE) {
  const _storage = getStorage(storage);
 ...
 */
export const setIdentityAsDefault = function (identity = null, storage = APP_SETTINGS.LOCAL_STORAGE) {
  const _storage = getStorage(storage);
 ...
 */
export const setRelay = function (relay = APP_SETTINGS.RELAY_ADDR) {
 ...
 */
export const updateDefaultId = function (storage = APP_SETTINGS.LOCAL_STORAGE) {
  // set the object storage
  const _storage = getStorage(storage);
 ...
 */
export const updateIdentity = function (identity, data, storage = APP_SETTINGS.LOCAL_STORAGE) {
  // set the object storage
  const _storage = getStorage(storage);
 ...
 */
export const updateIdentitiesNumber = function (isToAdd, storage = APP_SETTINGS.LOCAL_STORAGE) {
  // set the object storage
  const _storage = getStorage(storage);
 ...
 */
export const getDefaultIdentity = function (storage = APP_SETTINGS.LOCAL_STORAGE) {
  // set the object storage
  const _storage = getStorage(storage);
