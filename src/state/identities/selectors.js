...
export const getIdentity = (state, address) => getIdentitesState(state).get('identities').get(address);
...
export const getIdentities = state => getIdentitesState(state).get('identities');
